...
String ques = request.getParameter("m");
//String e=(String)session.getAttribute("ques");
...
if(rs.next())
{
	...
	st.executeUpdate("DELETE from question WHERE question='"+ques+"'");
...
<h1> YOUR SUBJECT IS DELETED</h1><BR><BR>

<A href="del-subject.jsp">CLICK HERE TO DELETE MORE...</A><BR><BR>
