...
<center>
<div class="loginbox">
		<h1>PLEASE UPDATE QUESTION HERE</h1>
		

<form action="update-question-handler2.jsp" method="post">

<div style="color:white ; font-type=cursive">SERIAL NO. </div>
<input type="text" name="sno" style="height:50px;width:50px" ><br>
<div style="color:white ; font-type=cursive">QUESTION </div>
<input type="text" name="question1" style="height:50px;width:1200px" ><br>
