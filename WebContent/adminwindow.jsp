...
%>
<li><a href="admin-logout.jsp">LOGOUT <%=session.getAttribute("email_id") %></a><li>
<li><a href="add-subject.jsp">ADD SUBJECT</a><li>
<li><a href="del-subject.jsp">DELETE SUBJECT</a><li>
<li><a href="add-question1.jsp">ADD QUESTION</a><li>
<li><a href="update-question.jsp">UPDATE QUESTION</a><li>
