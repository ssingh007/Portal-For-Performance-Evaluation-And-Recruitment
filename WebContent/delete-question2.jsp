...
<th STYLE="COLOR:WHITE;FONT-FAMILY:CURSIVE">SNO</th><th STYLE="COLOR:WHITE;FONT-FAMILY:CURSIVE">QUESTION</th><TH STYLE="COLOR:WHITE;FONT-FAMILY:CURSIVE"> OPTION 1 </tH><TH STYLE="COLOR:WHITE;FONT-FAMILY:CURSIVE"> OPTION 2</TH><TH STYLE="COLOR:WHITE;FONT-FAMILY:CURSIVE"> OPTION 3</TH><TH STYLE="COLOR:WHITE;FONT-FAMILY:CURSIVE"> OPTION 4</TH><TH STYLE="COLOR:WHITE;FONT-FAMILY:CURSIVE"> CORRECT OPTION</TH><TH STYLE="COLOR:WHITE;FONT-FAMILY:CURSIVE"> DELETE</TH>
<% 
...
String que=q.getQuestion();
	...
	<a href="delete-question-handler.jsp?m=<%=que%>">DELETE</a>
