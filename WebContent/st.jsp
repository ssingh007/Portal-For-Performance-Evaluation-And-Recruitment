...
<h1>ADDED SUBJECTS ARE</h1><BR><BR>
<P>SUBJECT 1 : <%=rs.getString("subject1")%></P>
<P>SUBJECT 2 :<%=rs.getString("subject2")%></P>
<P>SUBJECT 3 :<%=rs.getString("subject3")%></P>
<P>SUBJECT 4 :<%=rs.getString("subject4")%></P>
<P>SUBJECT 5 :<%=rs.getString("subject5")%></P>
<A HREF="adminwindow.jsp">CLICK HERE TO GO BACK...</A><br>
<A HREF="add-subject.jsp"> MAKE CHANGES TO SUBJECTS...</A><br>
</div>
<%
}
co.close();
