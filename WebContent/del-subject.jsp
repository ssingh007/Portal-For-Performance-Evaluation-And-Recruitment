...
<h1>DELETE SUBJECTS ARE</h1>
<P STYLE="COLOR:BLACK">SUBJECT ID : SUBJECT NAME</P>
<P>subject1 : <%=rs.getString("subject1")%></P>
<P>subject2 :<%=rs.getString("subject2")%></P>
<P>subject3 :<%=rs.getString("subject3")%></P>
<P>subject4 :<%=rs.getString("subject4")%></P>
<P>subject5 :<%=rs.getString("subject5")%></P>
<form action="delete-subject-handler.jsp" method="post">
<p>ENTER THE SUBJECT ID TO DELETE:<p>
